...
export interface UIStrings {
  ...
  participantMedicineViewOptional: string;
...
const en: UIStrings = {
  ...
  studentDataDesc: 'If you choose to save, your participant type, 81 answers, selected values, preferred specialty, optional study year, browser-computed ranking and, if provided, your written view of medicine are stored without your name or email for research. Saving records your consent; you can skip this step.',
  curiousDataTitle: 'Share your perspective on medicine',
  curiousDataDesc: 'If you choose to save, your participant type, 81 answers, selected values, preferred specialty, browser-computed ranking and, if provided, your written view of medicine are stored without your name or email for research. Saving records your consent; you can skip this step.',
  participantMedicineView: 'What do you think about medicine?',
  participantMedicineViewOptional: 'Optional',
  participantMedicineViewPlaceholder: 'Write your answer here…',
  participantMedicineViewPrivacy: 'Optional. If you answer, use 3 to 2,000 characters. Do not include names, contact details, or information that could identify you, a patient, or another person.',
...
const ro: UIStrings = {
  ...
  studentDataDesc: 'Dacă alegi salvarea, tipul de participant, cele 81 de răspunsuri, valorile, specialitatea preferată, anul opțional, clasamentul calculat în browser și, dacă o furnizezi, opinia ta scrisă despre medicină sunt stocate fără nume sau e-mail pentru cercetare. Salvarea înregistrează consimțământul; poți omite acest pas.',
  curiousDataTitle: 'Împărtășește perspectiva ta asupra medicinei',
  curiousDataDesc: 'Dacă alegi salvarea, tipul de participant, cele 81 de răspunsuri, valorile, specialitatea preferată, clasamentul calculat în browser și, dacă o furnizezi, opinia ta scrisă despre medicină sunt stocate fără nume sau e-mail pentru cercetare. Salvarea înregistrează consimțământul; poți omite acest pas.',
  participantMedicineView: 'Ce părere ai despre medicină?',
  participantMedicineViewOptional: 'Opțional',
  participantMedicineViewPlaceholder: 'Scrie răspunsul tău aici…',
  participantMedicineViewPrivacy: 'Opțional. Dacă răspunzi, folosește între 3 și 2.000 de caractere. Nu include nume, date de contact sau informații care te-ar putea identifica pe tine, un pacient ori o altă persoană.',
  participantMedicineViewCount: (current: number, maximum: number) => `${current}/${maximum}`,
...
const fr: UIStrings = {
  ...
  studentDataDesc: 'Si vous choisissez l’enregistrement, votre type de participant, vos 81 réponses, vos valeurs, votre spécialité préférée, votre année facultative, le classement calculé dans le navigateur et, si vous le fournissez, votre avis écrit sur la médecine sont conservés sans nom ni e-mail pour la recherche. Enregistrer vaut consentement ; vous pouvez passer cette étape.',
  curiousDataTitle: 'Partagez votre point de vue sur la médecine',
  curiousDataDesc: 'Si vous choisissez l’enregistrement, votre type de participant, vos 81 réponses, vos valeurs, votre spécialité préférée, le classement calculé dans le navigateur et, si vous le fournissez, votre avis écrit sur la médecine sont conservés sans nom ni e-mail pour la recherche. Enregistrer vaut consentement ; vous pouvez passer cette étape.',
  participantMedicineView: 'Que pensez-vous de la médecine ?',
  participantMedicineViewOptional: 'Facultatif',
  participantMedicineViewPlaceholder: 'Écrivez votre réponse ici…',
  participantMedicineViewPrivacy: 'Facultatif. Si vous répondez, utilisez entre 3 et 2 000 caractères. N’indiquez aucun nom, aucune coordonnée ni aucune information permettant de vous identifier, d’identifier un patient ou une autre personne.',
  participantMedicineViewCount: (current: number, maximum: number) => `${current}/${maximum}`,
